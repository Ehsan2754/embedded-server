  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">Status Monitor</div>
    ...
    <main class="container" style="margin-top:70px">
      <div class="category">Monitor</div>
      ...
      <tr>
        <td><div class="bodytext">Potentiometer 1</div></td>
        <td><div class="tabledata" id = "b1"></div></td>
        <td><div class="tabledata" id = "v1"></div></td>
      </tr>

      <tr>
        <td><div class="bodytext">Potentiometer 2</div></td>
    ...
    -->
    <br>
    <div class="bodytext">Buzzer Control (RPM: <span id="fanrpm"></span>)</div>
    <br>
